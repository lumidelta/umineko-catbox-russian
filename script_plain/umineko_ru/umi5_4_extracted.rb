...
it will probably be difficult to preserve Lord GOLDSMITH\'s magic for yet another family conference."
"W-......who are you?"
"Oh,
...
However, the magic world and the Human world are two different sides of the same coin."
"I understand.
......Of course, I will do all I can in the Human world.
...
On the contrary, I still can\'t even understand why that riddle exists.
.........That\'s right.
...
you don\'t go in tryin\' to beat the other guy.
......You get a pitfall ready, praise him a bit, and convince him to stand on it of his own accord."
...
......I am called Furudo Erika 古戸ヱリカ."
...
Isn\'t that the favorite move of you mystery people~
...
No proof is needed to show this.
......In short, there is absolutely no need to suspect this girl.
With this guarantee, you can theorize the same way as you always did, even now that she\'s appeared as a Human piece, right...?"
...
"the detective isn\'t the culprit" has been proclaimed in red, so you don\'t need to consider the exception.
...
But don\'t worry.
It has only increased by one person: Furudo Erika.
...
The people in the guesthouse have joined up with the rest, and now, all of the pieces except for Kinzo - all of the Humans - have gathered in the parlor."
"Looks like it.
...
......And now that one piece of BERNKASTEL\'s has been added......"
...
"She is probably Lady BERNKASTEL\'s piece.
......Though she will follow the rules of Humans, the player is a witch.
We can\'t underestimate her."
"Hmph, there is no problem.
Even if she were Lady BERNKASTEL herself, she is a Human, and so she is no match for us.
......After all, we have Gaap with us.
Humans certainly cannot win against Gaap!"
"............Thanks.
...
Only I, the Golden Witch and Endless Witch, BEATRICE!
Let us see how good Lady BERNKASTEL\'s next piece after Ange is.

...
However, if you match the Japanese syllables to numbers, you can read it as 1-10-1-9-9-6-0576."
11,019,960,576.
This massive number is equal to 18^8.
...
and send their stories out into the newest sea that Humans have discovered - the Internet - calling them the third or fourth message bottles...
...
"......Humans used to support geocentrism.
...
......However, it was hard to objectively prove it using the scientific techniques available at the time.
...
will serve as Reader and miko to the Witch of Theatergoing, FEATHERINE AUGUSTUS AURORA.

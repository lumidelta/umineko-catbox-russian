...
"Mine\'s a riddle.
Listen closely, now.
You know the story of Momotarou, right?"
...
You will?"
"Sure.
A quiz for the princess from her attendant
...
She lashed out at Eva, the only one who had returned alive, and accused her of stealing her parents away from her.
......Eva, understanding the wounds that this little six-year-old girl bore, withstood these attacks.
She grit her teeth and gave Ange her unconditional love.
...
The egg she is now will not be warmed by anyone, and neither will it hatch...
...
That\'s the emergency number for calling the police."(Add 20 to 99 and write it in reverse to get 911, the US number for both.)
...
After the first hour, it\'s burned down to half of 5 cm.
...
"......After one hour, 5 cm becomes 2.5 cm,
...and in the next hour, that becomes 1.25 cm,
...and in the next hour, that becomes 0.625 cm......"
"..........................."
"Ange-chan.
...
The candle goes out when it\'s 1 cm long, so the rest doesn\'t matter!"
The flame on this candle dies when the candle is 1 cm in length.
In other words, it can never get shorter than 1 cm.
So the right answer is the fifth choice, "About 10 mm"...!
"That\'s right...!"
"You are correct."

...
But we still have a lot left to get.
Next up is Shannon.
...
I\'ll trick you with my extra-hard puzzle, and make sure you never get my medal!"
...
"The key to the puzzle is the part about how many can she carry out of the room."
......Oh.
...
You suck, Ange, kihihihihihihihihihi,
ouch!"
"Maria!
Show some manners!"
...
There are lots of other puzzles in this book that are actually hard!"
...
Twelve years in the future, she will become the last person to inherit BEATRICE\'s name.
...
Even so, for me, the memory is eternal......
"How\'s it going, Ange?
...
"I\'m sorry.
Let\'s go then.
Now, all that\'s left are the cousins and BEATRICE, I guess."
"What is it?
...
"Yeah.
Now, there\'s only George onii-chan, Jessica onee-chan, Battler onii-chan, and BEATRICE left."
...
There\'s no way to know which one it\'s in.
......This really is...a test of luck.
In a way, this is even worse than a hard puzzle.
After all, you can always get a hard puzzle right - you just have to solve it.
...
"Ange~, are you sure you want the red box...?
...
In other words, they removed five losing slices.
...
Jessica-chan took one losing box away from the pair of boxes you didn\'t choose.
...
And just now, Jessica onee-chan removed a losing box from the boxes I didn\'t choose.
...
"Yeah.
There\'s only Battler onii-chan and BEATRICE left.
...
......Don\'t you think it\'s stupid to let it change around just because you hear someone else\'s words, just because you hear what they think the truth should be?"
...
Don\'t forget it."
"................................."
"All that\'s left is the puzzles from you and BEATRICE, and I\'m done."
"I see.
...
But whenever I get excited, I\'m always tired afterwards.
...
Everyone looked down upon Ange\'s sleeping face.
...
Ange\'s the final witch, ANGE BEATRICE."
...
And there, right by her pillow, was the gift from Kinzo, ......a BEATRICE corsage.
And there, right by her pillow, was the gift from Kinzo, ......a Battler doll.
And there, right by her pillow, was the gift from Kinzo, ......a BEATRICE doll.
...
As Ange slept, she was wrapped up in the soft sound of the rain.

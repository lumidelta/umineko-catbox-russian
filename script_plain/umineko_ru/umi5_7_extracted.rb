...
After all, not even she had yet seen it for herself.
...
"That is also fate.
It has been several decades since we first manifested in the Human world through our bond with Lord GOLDSMITH.
......It was all very fun."
".........Come on, Lia, you sound like an old lady.
......So, what\'re we going to do?
According to Riiche and GOLDSMITH\'s rules, now that Battler\'s solved the epitaph and decided not to become our master,
...
"In that case, you won\'t be relieved from duty for a while either, Lord GOLDSMITH.
...
You think this looks like somethin\' you can put off because he\'s tired?!
...
Of course not.
From Erika\'s dark nature, it was easy to guess what she was so happy about seeing.
...
VIRGILIA, who had suddenly appeared there, gave me an immediate answer to my question with the red truth...
...
"Yes.
......In the first place,
the gold of the Golden Land belongs to her from the start.
She has absolutely no need to make anyone find it for her or to snatch it away herself."
Of course.
...
"......You could say that.
Whether the epitaph\'s riddle is solved or not, she has nothing at all to gain from it."
"It doesn\'t matter whether it\'s solved or not.
......Doesn\'t that mean that the epitaph\'s riddle itself has no value to Beato...?"
"..................
......I suppose.
...
X=Y.
And whether the epitaph\'s riddle is solved or not, Beato gains nothing.
Y=0.
...
This was always the first place I stumbled.
...
Battler-kun, you are not the culprit.
...
My idea that Beato must have been taking revenge on me...has already been refuted in red by VIRGILIA.
Both X and Y...

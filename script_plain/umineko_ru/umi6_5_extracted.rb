...
"So?
Did you see BEATRICE or didn\'t you?"
"Oh, umm,
...
"My little sister.
Do you understand the anti-magic toxin that Humans possess?"
"N-no.
What is that, Onee-sama?"
"Hmm.
The time of witches has long since passed.
......Those vile Humans who claim to control everything came to deny our existence and possess a strong toxin."
...
a different type of being than Humans.
...
"Correct.
You can think of it as though Human eyes radiate the toxin.
...
"If we stock up magical power and have it acknowledged by Humans, that toxin can be reduced drastically.
In other words, by having our existence acknowledged by Humans, we make them lose their toxin,
...
which makes us inferior to even a stray cat hiding from Humans in the shadows."
...
striving to regain her magical power and reduce the anti-magic power of the Humans...
The powerful previous BEATRICE, whom she had read about in FEATHERINE\'s library,
had appeared openly in front of Humans and had even toyed with them at will.
...
"Yes.
......She was like a witch from a picture book, appearing openly before the Humans of the mansion and summoning magic and underlings at will..."
"Hmmm, how inspiring.
...
"Let us put it in the toxin-filled words of a Human.
...
The servants already call me the witch BEATRICE, master of the night,
...
When Humans are warned that they\'re about to enter a famously haunted place, a hot spot for ghosts,
...
...Those Humans who can only conceive of a single possibility are unable to imagine anything."
"However, people who believe in the possibility of a witch can imagine that it was a witch\'s prank.
......When that happens, the scene of the BEATRICEs\' prank that we have just seen is etched into the fragment as a fact..."
...
is that the ghost BEATRICE, who was called the ruler of Rokkenjima\'s night, doesn\'t really exist.
It\'s nothing more than a general term for any inexplicable occurrences that took place in the mansion at night.
In other words, BEATRICE isn\'t the name of a person, it\'s the name of a phenomenon."
If anything bizarre happens, it all becomes the work of the Golden Witch...
Any environment in which "there could be a witch" is, in fact, BEATRICE itself.
"......That all piles up until we reach 1986.
......This is the veil that the true culprit is hiding behind.
And the person hiding behind it is, without a doubt, one of the Humans."
...
Sheesh."
"I\'m sure BEATRICE wanted to gaze at the moon.
Uu."
...
"However, this "Golden Witch BEATRICE" that we hope and fantasize might exist...
...
Founder of Mariage Sorciere and Witch of Origins, MARIAAAAAAAAAAAAAAAAA!!"
"Lady ERIKA, this opponent is not worth your TIME.
...
"<Good>!!
Is this what you call BEATRICE\'s magic?!
Dlanoooooooooor!!"
"Beat
her
to
...
"A repetition has been REQUESTED.
Failure to respond will be a violation of Knox\'s seventh COMMANDMENT."
...
"Hidden devices and tricks are in violation of Knox\'s third COMMANDMENT.
However, if and only if foreshadowing has been presented, these are permitted by Knox\'s eighth COMMANDMENT."
...
"They had no tricks like that in them!!
It was just an ordinary table and an ordinary cup!!
So it\'s magic, not a trick!!"
"......UNDERSTOOD.
......By Knox\'s ninth commandment, Lady MARIA\'s account of witnessing magic is PERMISSIBLE."
"Ahahahahahahahahaha!!
...
"...So, if a Human like me could use it too,
...
Impossible, impossible, useless, useless! There\'s no way a Human can do it!!"
...
If a lowly Human saw it, the miracle of magic would be wiped out of existence!!
That\'s why there\'s a rule that says lowly Humans have to close their eyes when using magic!!"
"I see, I see. Okay, I understand the protocol used by Humans performing magic!!
...
」
"While you had your eyes closed, I just lifted the cup up and tossed a candy in!!
You call that magic?
It\'s just a third-rate triiiiiick, hyahhaaaaaaah!!!"
"There\'s my blue truth as the detective.
And now, as the Witch of Truth, I present to you: my red truuuuuuuuuuth!!!"
Your so-called candy magic is nothing more than sleight of hand!!
A mere trick that the fake witch calling herself BEATRICE or whatever claimed was magic!!"
...
"Everything you ever thought was magic was just a trick that you didn\'t get!!
There\'s no way there\'s such a thing as magic! There\'s no way magic exiiiiiiiiiiiiiists!!"
"......Huuuh?!"
"P-putting the candy in this cup might have been your sleight of hand,
but that doesn\'t prove that Beato\'s magic was also a sleight of hand.
Uryuuu!!!"
"However, you also can\'t prove that it could only have been done with magic!!
...
"That is ENOUGH.
Lady MARIA has been shown that the magic which makes candy appear in a cup could possibly be a trick that she misunderstood to be MAGIC.
Therefore, her claim that it was magic is DISMISSED."
"However, it might really have been magic when Maria saw it...!
Just because it can be done by a sleight of hand doesn\'t disprove magic."
"......Well done, Lady ERIKA.
Congratulations on crushing Lady MARIA\'s witch ILLUSION."
...
It was still too early to bring the fight into the domain of denying everything else Maria believed in: the existence of BEATRICE, witches, and magic......
...
"She did NOT.
......Let us WITHDRAW.
Lady MARIA is no match for you, Lady ERIKA.
There is no need to pay any attention to small fry such as THIS."
"............Hmph.
......You\'re right.
...
They do exist here and there...Humans that are practically lumps of the toxin that doesn\'t believe in magic!
...
I may not look it, but I\'m BEATRICE\'s disciple!

Erika was dozing off on the bed, so when a knock sounded on the door,
...
......If Erika can win this game as a Human without the detective proclamation, it will be impossible for Battler and the others to pick up the pieces of the witch illusion."
...
"......See?
Balanced, right?
The ultimate victory of destroying the witch illusion as a mere Human, not a superhuman "detective".
...
"Come to think about it, when Battler played for the Human side, he never had anything as convenient as the detective\'s authority.
...
Just fitting for the first one to discover the crime.
"Please calm down.
...
"Battleeer...! Battleeeeeeer......! Dammiiiiit......! Aaaaaaaaaahhh......"
"H-......how sad......"
...
...By which I mean, the murders must be possible to commit without magic.
...
They have to make a crime that can be reproduced with tricks and not magic.
As long as the Human side can\'t figure out those tricks, the witch side can use all kinds of magic and illusions.
......In other words, in order to carry out a locked-room murder with magic,
it is necessary to create a crime that is possible to carry out by Human hands.
".........By now, I understand.
...
"Yes? What is it?"
"It is true that you have an incredible photographic MEMORY.
......When you combine that with the detective\'s proclamation, it becomes impossible for you to be fooled by ANYTHING."
...
the possibility will always remain that they were faking their DEATH.
It will probably be necessary to give Battler repetition requests to confirm the details of each situation INDIVIDUALLY."
...
"We have checked all of the crime scenes and finished gathering INFORMATION.
Here is our REPORT."
"Go ahead."
"First, all of the rooms employ window locks and chain locks...
to form locked rooms in a way that would be "difficult to interfere with from the OUTSIDE".
The only exception is the parlor, where Rosa and Maria lay DEAD."
...
"It is probably his goal to construct locked rooms where explanations using master keys are made completely INEFFECTIVE.
The parlor has no chain lock due to its very nature, so it is natural that something else would be used in place of a CHAIN."
...
I\'m, like, a super great detective"
...
.........If Battler and Beato are defeated by a mere Human who isn\'t even a detective, they\'ll fall apart in the most exquisite way, don\'t you think?"
...
......Be like this forever, BERNKASTEL.
Seeing your face twist with anguish is the one forbidden honey I\'ve found for myself."
LAMBDADELTA had guaranteed that it was a perfect locked room.
...
"UNDERSTOOD.
......We request that the following be REPEATED."
...
"First.
"The rooms with the six people in them are all locked ROOMS"."
"Acknowledged.
...
"Second.
"The definition of locked room implies that it is impossible to construct from the OUTSIDE"."
"Acknowledged."
...
"Third.
"The definition of a locked room implies that all forms of interference between the inside and outside of the room are PREVENTED"."
"Acknowledged.
...
"Fourth.
"At the time of the breaking of the locked rooms, none existed within the rooms except the VICTIMS (Natsuhi, Eva, Kyrie, Rosa, Maria, Battler)"."
"Acknowledged."
...
"Fifth.
"No murder was committed after the breaking of the locked ROOMS"."
"I decline."
"......Why?
...
Krauss\'s group cut the chains and destroyed the locked rooms, then killed the people inside.
I just want you to argue against this."
"Lady ERIKA, ......the undefined plurality of "Krauss\'s group" is INSUFFICIENT.
You should first check to see which humans entered the rooms after the locked rooms were BROKEN."
"For your attention:
...
"Tch...! Dlanor!"
"Let us CONTINUE.
Sixth, "the victims did not die by any method other than HOMICIDE"."
"Acknowledged."
...
Beato thought back on the books she had read in FEATHERINE\'s archives, in which the old her and Battler had fought.
...
"So, what, you\'re saying Aniki killed Kyrie and the others?!
...
......The siblings may have harbored hatred for each other, but they could never have hated each other\'s wives enough to kill them.
...
you could probably set the chain from the outside by using a wire as well.

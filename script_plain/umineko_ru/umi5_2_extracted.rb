...
BEATRICE was casually sitting on the roof of the arbor,
...
Kinzo is already dead, remember?
...
"Why don\'t you do what you usually do and start holding your head, crying "this doesn\'t make any sense!!"...?
C\'mon, use that old "it\'s no goddamn good at all" catch phrase and let me hear your classic crazy counterargument."
...
Would you mind?"
"............
......The reason Grandfather is strolling around like nothing happened even though he\'s already dead...
...
"
Because of this, the illusion of Grandfather is unable to appear in front of people who aren\'t in on this with Aunt Natsuhi.
...
That\'s why it was possible for an illusion of Grandfather to exist in the study.
That\'s right, in the games before now,
the only people who met Grandfather were Uncle Krauss,
Aunt Natsuhi, and the servants.
Because they all stuck to the same story,
...
In the mystery genre, hidden passages mustn\'t exist.
...
That\'s what sounds like fantasy to me..."
...
......You\'re fighting to kill that girl."
"..............."
...
To describe it in Japanese terms, it was like age-gyoza stuffed with mashed, curry-flavored potatoes.
...
With Chinese tea, you have xiaolongbao.
...
What was he doing, when and where was he doing it, and what did he change?
...
And the coordination between the two of them and the servants had also been spectacularly intricate......
...
......As a witch, it seems that you\'re in Lady LAMBDADELTA\'s camp.
...
Then, with an expression that didn\'t reveal her thoughts in the slightest, BERNKASTEL spoke while looking at Beato\'s face.
...
Even if BEATRICE tries to yield or gets discouraged or gives up,
...
this witch called LAMBDADELTA can probably try to buy time for Beato\'s condition to turn back around.
...
So, BERNKASTEL\'s words were the truth.
...
You and that LAMBDADELTA witch have nothing to do with this.
I will kill her.
...
"Unless this game is resolved, you will never be released.
...
is because LAMBDADELTA, who is the Game Master and the one who is telling the story, is interpreting it that way."
...
but there is a possibility that Aunt Natsuhi really is drinking tea with some unknown person X calling themselves BEATRICE.
...
"In that case,
it\'s possible to claim that Aunt Natsuhi really did drink tea with a woman calling herself BEATRICE.
...
"She really excels at controlling a Human\'s heart.
...
......VIRGILIA called them your friends, but...
...
......Her truth, which was only hers and observed by no one else, had been defiled.
In Natsuhi\'s world,

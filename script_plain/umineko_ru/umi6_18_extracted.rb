...
"UNDERSTOOD.
I will tell HER.
......Gertrude, contact the head of ceremony SECURITY.
......Prepare for BATTLE."
"As you wish."
...
That\'s impossible...!"
"Cornelia is heading there NOW.
......The odds of BEATRICE attacking here are extremely HIGH.
I recommend suspending the reception and EVACUATING."
...
When BERNKASTEL saw this, ......she knew that their final, late guest would soon be arriving.
"Luci-nee.
...
"That\'s impossible.
It\'s been guaranteed that "everyone" is in the cousins\' room except the specific names Lady ERIKA read aloud back then.
...
"......Lady ERIKA, let us evacuate to the waiting ROOM.
It is dangerous HERE."
"What\'s dangerous?!
I\'m the territory lord of this world!
Why should I have to run away in fear?!"
"Gertrude, set up a VIP guard BARRIER.
Call Cornelia back here at ONCE."
...
......When VIRGILIA saw the object in his hand, she understood its meaning...
...
Was it because she had been warned about shooting these guests...and was afraid of the consequences if she accidentally shot a drunk guest who had disguised themselves as BEATRICE as some sort of prank?
...
Who could possibly mistake this overwhelming presence?
"B-
......Beatriiiiiiii
ceeeeeeeeee!!!"
...
There was no way they could carry Battler away in that time...!
...
Data link to 410!!"
410 was clever.
She had predicted that VIRGILIA would go for a spirit particle attack...and had folded over her ears and 45\'s beforehand.
...
She stepped forward and laid out a last line of defense to block Beato\'s way.
...
Though she was resilient enough to do justice to the name of Eiserne Jungfrau and took no damage at all,
...
".........You are LATE.
......Time is already up, Lady BEATRICE!!"
...
"......I have received a red truth denying you from Lady BERNKASTEL.
......I am afraid that this will become your GRAVE...!"
...
"You will be the one to RETREAT...!!
You are the pitiable actor who has chosen the wrong time to appear on STAGE!!"
...
You have managed to fix the logic error, I assume...?"
...
......Some lasted a short while, others longer.
...
At any rate, ......now I\'ve paid back all of my debts.
...
......I felt that I needed to protect YOU.
...
"Naturally."
"Of course."
""Lady LAMBDADELTA, the great and powerful Witch of Certainty and member of the glorious Senate!!
Please come forward!!
Will you swear to oversee this duel?!!""
"Of course.
I swear it."
The crowd split, and LAMBDADELTA walked forward with BERNKASTEL by her side.
...
BEATRICE will load hers with red truth to counter back.
...
......That room is a perfect locked room, so there is no way to escape.
...
That check I performed must be suspect.
...
don\'t need to be inside the cousins\' room!
...
"The cousins\' room is guaranteed to be a perfect locked room until the end.
So, if Kanon really had been in that room, it would have been impossible for him to escape!
...
BEATRICE, the witch who mocks others with unsolvable locked room tricks...!
"At the time the next room over was sealed,
...
I\'ll crush them all with repetition requests!!
...
I want to immediately remove the possibility that I rescued him accidentally.
"A "rescuer" means someone who reset the chain lock after Battler undid it.
...
The game ended while I was inside the guest room,
so I did not undo the chain lock that I had previously set.
So, it can\'t be that he escaped behind my back after I left the room.
Furthermore, the chain lock was set at the same time I entered the room.
No one could have left the room during the few seconds between the time I entered and the time I set the chain lock.
I sealed the guest room at the time I examined Battler\'s "corpse",
so until I came again and broke the seals, it was absolutely impossible for anyone to go in or out.
Therefore, it\'s certain that Battler was hiding somewhere inside the guest room at the time that I entered it.
The only chance Battler had to escape was after I broke the seals.
To be even more specific, he had no chance to escape except for the time I was in the bathroom.
By the above premises, Battler\'s trick to escape with the chain still set is as follows!
For the aforementioned reasons, the only one who could have set the chain lock, which can only be set from the inside, and allowed Battler\'s escape...
is Kanon, the only person to enter the room except for me and Battler!
After Kanon entered the room, he set the chain,
...
When we examined the bedroom, there was nothing there.
...
"Что бы я ни делал, это мой личный выбор."
.........*giggle*...
...
I see, now I get it...
It\'s an interchangeable logic trick...!
...
I have to expose both at the same time, or it isn\'t checkmate...!
Incredible......
...
"............Then come."
"......
\'Battler\'s guest room disappearance trick\' is as follows.
...
Diiiiiiiiiiiiiee, Kanoooooooooooooooonnn!!"
...
VIRGILIA, Gaap, and Ronove did the same.
All of the Seven Sisters also crowded about him in delight.
"......Heh,
......heheh,
......that\'s a nasty trick...
You sure something like this counts......?
With a trick like this one, those Humans will start complaining again about how this isn\'t mystery......"
"No, it\'s a splendid trick!
That just can\'t be \'seen\' by people without love...!
......Battler-san,
........Battler-san,
......waaaaaaaaaaaaaahhh...!!!"
"Lady ERIKA, Lady ERIKA!!
Someone, help her, QUICKLY!!"
...
"L-Lady BERNKASTEL, give your approval for her RESURRECTION!!
......Lady BERNKASTEL...?! Wh-where did she GO...?!"
...
......That sort of expression......is a loser\'s greatest salvation...

...
......We just, umm - "
"Not even Dad is immortal - he\'s gonna die someday.
We aren\'t telling him to die. We\'re just saying that he will die someday.
...
"Yes.
It is a responsibility of the successor to the head, isn\'t it?
...
".........Hoh.
Then what kind of case do you imagine would cause the caregiver to be blamed for making a blunder?"
"For example,
......if he disappeared."
".....................
...............Hoh?"
...
It was never guaranteed that the 18 names = the 18 people on the island.
...
"By doing that, even though the culprit is on the island, she was able to leave them out of the list of the 18 alive or dead people!
The person who was mixed in isn\'t on the island, so he doesn\'t count towards the total number of people on the island."
"Therefore, even though the culprit counts towards the total of 18 people on the island, it was possible for their name to not be listed!
...
......no,
if he dies, but it isn\'t announced, the distribution of the inheritance doesn\'t occur."
...
"Yes.
The use of the red truth is basically a right the witch has, to exercise as she pleases.
...
But when and only when your claim would destroy the witch theory, it does become her responsibility.
...
Through my repetition requests, I\'ve been able to strengthen my position and advance bit by bit.
...
"Now, now, Battler, if you make a despairing face like that, I won\'t be able to stop drooling, you knowwww?
...
and there is no counterargument from the witch side, then the human side can declare victory.
......Any problems?"
...
"The number of master keys is five".
...
"The actual number of master keys was greater than five.
...
......The only way to kill him without an autopsy would be for him to disappear."
...
Which is why it was so sickening...
...
"And it should even be possible for you to borrow it from Father, right?
...
Wahhahahahahahahaha, and this is my successor?
...
Natsuhi ran up to him and cared for him...
...
"............I thought that as long as I could meet BEATRICE, I would have no regrets in my life,
